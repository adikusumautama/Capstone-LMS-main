        ...
        <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="300">
          <div class="member d-flex align-items-start">
            ...
            <div class="member-info">
              ...
              <span>Anggota</span>
              <p>"Manusia tidak butuh kata-kata mutiara"</p>
              <div class="social">
                <a href=""><i class="ri-twitter-fill"></i></a>
                <a href=""><i class="ri-facebook-fill"></i></a>
        ...
        <ul>
          ...
          <li data-aos="fade-up" data-aos-delay="400">
            ...
            <div id="faq-jadwal" class="collapse" data-bs-parent=".faq-list">
              <p>Anda dapat melihat jadwal kelas Anda dengan masuk ke platform online kami atau mengunjungi halaman jadwal di situs web LMS. Informasi terkait jadwal, ruangan, dan pengajar akan tersedia di sana.</p>
            </div>
          </li>
